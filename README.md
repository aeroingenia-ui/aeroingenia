...
| `.claude/agents/` | Los 7 agentes especializados del proyecto: agronomía, marketing, evaluación comercial, ingeniería comercial, desarrollo web, QA y audiovisual. Claude Code los descubre al iniciar la sesión y se invocan por nombre |
