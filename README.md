...
| `.claude/agents/` | Los 8 agentes especializados del proyecto: agronomía, robótica, marketing, evaluación comercial, ingeniería comercial, desarrollo web, QA y audiovisual. Claude Code los descubre al iniciar la sesión y se invocan por nombre |
